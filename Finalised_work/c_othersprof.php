   ...
   var b=parseInt(aa);
		   ...
		   $.ajax( 
		   {
			...
			dataType: "json",
			 ...
			 if(lol.status==1)alert("You have no Projects");
			 else
                            ...
                            <ul>
                                ...
                                <li><a href="#"><i class="icon-user-2"></i>My Profile</a></li>
                                    ...
                                    <ul class="dropdown-menu" data-role="dropdown" style="display: none;">
                                        ...
                                        <li><a href="c_elseproj.php?suid=<?php echo $_SESSION['Uid'];?>">My Projects</a></li>
                        ...
                        <div class="frames">
                            ...
                            <div class="grid"><div class="row">
                                ...
                                <div  class="span5">
									...
									<li class="place-right"><div id="omg"><button class="recruit large primary" id="recruit"><i class="icon-star"></i> Recruit</button></div></li> <br><br>
