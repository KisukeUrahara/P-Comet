						...
						$.ajax({
								...
								success: function(data){
										...
										$.each(data,function(i,item){
												$("#request").append("<a href=\"#\" class=\"list\"><div class=\"list-content bd-black\"><img src=\""+item.vidurl+"\"style=\"height:100px%;width:80%;\" class=\"icon\"/><div class=\"data\"><span class=\"text-muted place-right\" style=\"font-size: 12px;\">"+item.tsp+"</span><span class=\"list-title place-left\">&nbsp &nbsp <legend>Name:<i>"+item.project_name+"</i></legend><legend>Description: <i>"+item.Description+"</i></legend><legend>Stream: <i>"+item.Stream+"</i></legend></span><br><button class=\"large info\" ><a href=\"http://localhost/Projectx/Finalised_work/projectDisp.php?pid="+item.Project_id+"\">View Page </a></button> <br><br><br></div></div></a>");
										});
								} ,
								error: function(){
									alert("error1");
				...
				$(document).ready(function(){
						$.ajax({
								...
								success: function(data){
												...
												$('#sacrequest').append("<div class='list-content bd-black'><img src='"+item.dpurl+"'style='height:50%;width:50%;' class='icon'/><div class='data'><span class='text-muted place-right' style='font-size: 12px;'>"+item.tsp+"</span><span class='list-title place-left'>&nbsp &nbsp <legend>Sent By: <i>"+item.Name+"</i></legend><legend>For Project:<i>"+item.project_name+"</i></legend></legend></span><br><button id=\"preetiaccept\"class=\"large info\"><a href=\"http://localhost/Projectx/updworkson.php?suid="+item.uid+"&pid="+item.Project_id+"&uname="+item.Name+"\">Accept Request </button> <button class=\"large\"><a href=\"http://localhost/Projectx/Finalised_work/c_othersprof.php?uid="+item.uid+"\">See Profile </button><br><br><br></div></div></a>");
										});
								} ,
								error: function(){
						...
						$.ajax({
								...
								success: function(data){
												...
												$('#sacrequest7').append("<div class='list-content bd-black'><img src=\""+item.vidurl+"\"style='height:50%;width:50%;' class='icon'/><div class='data'><span class='text-muted place-right' style='font-size: 12px;'>"+item.tsp+"</span><span class='list-title place-left'> &nbsp &nbsp <legend>Invited By: <i>"+item.Name+"</i></legend><legend>For Project:<i>"+item.project_name+"</i></legend></legend></span><br><button id=\"preetiaccept\"class=\"large info\"><a href=\"http://localhost/Projectx/updworkson.php?suid=<?php echo $_SESSION['Uid'];?>&pid="+item.Project_id+"&uname=<?php echo $_SESSION['myusername'];?>\">Accept Invite </button> <button class=\"large\"><a href=\"http://localhost/Projectx/Finalised_work/c_othersprof.php?uid="+item.auid+"\">See Profile </button><br><br><br></div></div></a>");
										});
								} ,
								error: function(){
