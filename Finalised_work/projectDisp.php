...
<div class="container"><br>
                        ...
                        <tr><td class="text-center"><h3><div id="shima1"></div></h3></td><td class="text-center"><h3><center> 
								   ...
								   <br> <tr><td class="text-center"><h3>Members: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admin:</h3></td>
        ...
        <table style="width:100%; height:100%">
            ...
            <tr>
                <td style="vertical-align: middle;" valign="middle" colspan="2">
                    <div style="width: 480px; height: 400px; border-right: darkslategray thin solid; border-top: darkslategray thin solid; font-size: 10pt; border-left: darkslategray thin solid; border-bottom: darkslategray thin solid; font-family: verdana, arial; overflow:scroll; text-align: left;" id="DIV_CHAT"></div>
