...
<nav class="navigation-bar dark" style="width:100%">
    ...
    <div class="container">
                <h1>
                    ...
                    Chat<small class="on-right">ing</small>
                </h1>
                    ...
                    <div class="balloon right">
                        <div class="tab-control padding20" data-role="tab-control">
                            <p class="place-right tertiary-text">messaging</p>
                            <ul class="tabs">
                                <li class="active"><a href="#write">Write</a></li>
                                <li><a href="chat.html">Preview</a></li>
                            </ul>

                            <div class="frames">
                                <div id="write" class="frame">
                                    <textarea data-transform="input-control" placeholder="write your text here"></textarea>
                                </div>
